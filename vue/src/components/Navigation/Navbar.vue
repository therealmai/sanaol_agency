  ...
  <nav class=" bg-white drop-shadow-lg flex sticky top-0 z-50 justify-between items-center space-x-4 h-[77px] min-h-[77px] w-full">
    ...
    <div class="space-x-6 pr-4">
      ...
      <span v-if="isLog == true">
        ...
        <!-- Remove toUpperCase() as there is no to case changing keyword in selenium version used -->
        <span class="bg-[#F6F5FF] p-2 rounded-[7px] text-primary pr-6 pl-6 cursor-pointer">{{ user.fname }}</span>
