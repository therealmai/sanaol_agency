  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p class="mb-2">
          <a href="#!" class="text-white">(032) 255 0111</a>
        </p>
        <p class="mb-2">
          <a href="#!" class="text-white">info@system.com</a>
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-2">
          <a href="#!" class="text-white">Monday to Friday</a>
        </p>
        <p class="mb-2">
          <a href="#!" class="text-white">8:00 AM to 6:00 PM</a>
        </p>
      </div>
      <div class="">
        <h6 class=" font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p class="mb-2">
          <a href="#!" class="text-white">J Block Bldg, Brgy. 3 571, The, 2 Apitong St, Cebu City, Cebu
        </a>
        </p>    
      </div>
      <div class="">
        ...
        <div class="flex justify-start">
                ...
                class="w-7" role="img" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512">
                <path fill="currentColor"
            ...
            <a href="#!" class="mr-4 text-white">
                ...
                class="w-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor"
