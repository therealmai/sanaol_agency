<template>
    <div>
        ...
        <h1 class="mb-10 text-secondary" style="font-weight: 700; text-align: center; font-size: xx-large; ">Edit News</h1>
        <div class="flex flex-col items-start form-cont gap-8">
            <form enctype="multipart/form-data" method="patch" class="flex flex-col items-start gap-5" action="">
                ...
                <div>
                    ...
                    <input v-bind:class="[cssFormInputs]" v-model.trim="news.title" type="text">
                </div>
                <div>
                    <label for="content">Content</label>
                    <textarea v-bind:class="[cssFormInputs]" class="h-[221px]" v-model.trim="news.content" type="text"></textarea>
                </div>
            </form>
            ...
            axios.get('/news/' + id).then(
                (response) => {
                    if(response.status == 200) {
                        ...
                        this.previewImg = this.news.image;
