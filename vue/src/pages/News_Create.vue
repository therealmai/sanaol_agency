    ...
    <div style="margin-left: 320px; margin-top: 20px;">
        ...
        <div style="margin-left: 100px; margin-top: 30px;">
            ...
            <form enctype="multipart/form-data" method="patch" class="flex flex-col items-start gap-5" action="">
                ...
                <div >
                <newsInput width="528" height="49.6" fontSize="16" holder="News Title" v-model.trim="news.title"></newsInput><br><br><br>
              <div>
                  <textarea class="h-[221px]" style="border-width: 1px; border-color: #A8A8A8; padding: 10px 10px; width: 528px; border-radius: 3px; color: #525252;" placeholder="Content" v-model.trim="news.content" type="text"></textarea><br><br><br>
              </div>
              </div>
        ...
        <div class="flex gap-4">
            ...
            <OutlineButton class=" pl-4 pr-4" fontSize="12" color="white" text="Cancel" width="99" height="36" @click="goBackTonews"/>
            </div><br><br><br>
        </div>
        ...
        <Modal v-show="isUpdateModalVisible">
            <template v-slot:modal_content>
                ...
                <p class="modal-paragraph">Are you sure you want to save the changes<br>made on this news? Please confirm.</p>
                <Info text="Saving the changes will change what the public sees on the news page."></Info>
                <div class="flex gap-10 mt-5 mb-5">
                    <FilledButton id="updateButton" class="w-[100px]" text="CONFIRM" @click="updateNews(), confirmUpdateModal()"></FilledButton>
         ...
         <UpdateModal id="myupdatemodal" text="news" v-show="isConfirmUpdateModal" @click="closeModal">
         </UpdateModal>

        
        
        <DeletedModal id="mydeletemodal" text="news" v-show="isConfirmDeleteModal" @click="closeDeleteModal">
        </DeletedModal>
...
import newsInput from '../components/Input/EventsInput/modelValueInput.vue'
